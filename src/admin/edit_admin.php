...
if (isset($_GET['id'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($conn->query($updateQuery) === TRUE) {
            echo "<script>
                ...
                window.location = 'admin_tabel.php';
            </script>";
        } else {
            echo "<script>
    ...
    header("Location: admin_tabel.php");
    exit;
}
...
<body class="bg-gray-100 font-poppins">
    ...
    <div class="max-w-4xl mx-auto p-8 bg-white rounded-lg shadow-lg mt-8">
        ...
        <h2 class="text-3xl font-semibold text-center text-gray-700 mb-6">Edit Data Admin</h2>
        ...
        <form method="POST" action="">
            <div class="space-y-4">
                ...
                <div class="flex justify-between">
                    ...
                    <a href="admin_tabel.php" class="bg-red-600 text-white font-semibold py-2 px-6 rounded-md hover:bg-red-700">Batal</a>
                </div>
            </div>
        </form>
    </div>
